    ...
    <section className="py-[80px] relative overflow-hidden" id="culture">
      ...
      <div className="absolute top-1/3 right-[15%] z-20 animate-spin-slow">
        <svg width="120" height="120" viewBox="0 0 100 100">
          ...
          <text width="500" fill="#1f299b" fontWeight="bold" fontSize="14">
            <textPath xlinkHref="#curve">THE MIND * THE MIND * THE MIND *</textPath>
          </text>
          <circle cx="50" cy="50" r="20" fill="#1f299b" />
        </svg>
      </div>
      ...
      <div className="absolute bottom-10 left-10 md:left-[15%] w-64 bg-black text-white p-4 rounded-xl shadow-2xl flex items-center gap-4 z-20 culture-img">
        <div className="w-12 h-12 bg-mind-green rounded flex items-center justify-center text-black font-bold">◆</div>
        <div>
          <div className="text-xs text-gray-400">Platform</div>
          <div className="font-bold text-sm">The Mind</div>
        </div>
      </div>
      </div>
    </section>
