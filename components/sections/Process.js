      ...
      <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          <div className="md:col-span-5">
            <div className="flex items-center gap-2 text-mind-blue font-bold uppercase text-xs tracking-widest mb-6">
              <span className="w-2 h-2 bg-mind-blue rounded-full"></span> How We Work
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="group relative bg-white border border-gray-200 rounded-2xl p-8 hover:border-mind-blue hover:shadow-2xl transition-all duration-500 cursor-pointer">
              ...
              <div className="text-mind-blue text-sm font-bold mb-4">{step.number}</div>
              <h3 className="text-3xl font-bold mb-4 group-hover:text-mind-blue transition-colors">
                {step.title}
              </h3>
              <p className="text-gray-600 leading-relaxed">
                {step.description}
              </p>
              <div className="mt-6 w-12 h-1 bg-gray-200 group-hover:w-full group-hover:bg-mind-blue transition-all duration-500"></div>
            </div>
          ))}
        </div>
      </div>
