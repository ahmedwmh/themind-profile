...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const animateRandomCell = () => {
      ...
      cell.style.backgroundColor = '#9df904';
    ...
    <section className="md:min-h-screen minWH700:!h-[670px] minWH700:!min-h-full pt-32 flex flex-col items-center relative overflow-hidden" id="platforms">
      ...
      <div className="z-20 text-center mt-10 pb-6 md:mt-20 mix-blend-multiply">
        <div className="overflow-hidden">
          <h1 className="hero-title text-[14vw] md:text-[12vw] xl:text-[175px] leading-[0.9] font-extrabold tracking-tighter uppercase text-black">THE</h1>
        </div>
        <div className="overflow-hidden">
          <h1 className="hero-title text-[14vw] md:text-[12vw] xl:text-[175px] leading-[0.9] font-extrabold tracking-tighter uppercase text-black"><span className="text-mind-blue">MIND</span></h1>
        </div>
        <div className="mt-8 opacity-0 hero-btn">
          <button onClick={toggleContact} className="border-2 border-mind-blue text-mind-blue px-8 py-3 rounded-full text-sm font-semibold uppercase tracking-wide hover:bg-mind-blue hover:text-white transition-all duration-300 flex items-center gap-2 group mx-auto bg-white/50 backdrop-blur-sm">
            Get In Touch <span className="group-hover:rotate-90 transition-transform duration-300">↓</span>
          </button>
        </div>
      </div>
      </div>
