    ...
    <footer className="bg-black text-white pt-24 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
        <div>
          ...
          <div className="flex items-center flex-wrap sm:!flex-nowrap gap-4">
            <a href="https://www.themind-platform.com/" target="_blank" rel="noopener noreferrer" className="text-3xl font-bold hover:opacity-90 transition">The Mind<span className="text-mind-green">*</span></a>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-sm text-gray-400">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a href="https://www.themind-platform.com/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">themind-platform.com</a>
          </div>
          <div className="flex flex-col gap-3">
            <h4 className="text-white font-bold mb-2">Platform</h4>
            <p>The Mind Platform</p>
            <p>Tech education & development</p>
            <p>Across the Arab world</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-white/10 pt-8 flex flex-col lg:flex-row justify-between items-center text-xs text-gray-500 gap-4">
        <div className="flex gap-4">
          <span>© 2025 The Mind — All rights reserved</span>
        </div>
        <div className="flex gap-4">
        ...
        <div className="flex items-center gap-2">
          <span className="text-mind-green">◆</span> Built with precision & care
        </div>
      </div>
      </div>
    </footer>
