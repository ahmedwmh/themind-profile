    ...
    <div id="project-overlay" className={`fixed inset-0 bg-white z-[70] overflow-y-auto transition-all duration-700 ease-in-out ${isOpen ? 'translate-y-0 opacity-100 pointer-events-auto' : 'translate-y-full opacity-0 pointer-events-none'}`}>
      ...
      <div className="min-h-screen pt-32 px-6 md:px-20 pb-20 max-w-7xl mx-auto">
        <div className="project-anim-item">
          <span className="inline-block px-4 py-1.5 border border-black rounded-md text-[10px] font-bold uppercase mb-8 tracking-widest bg-mind-blue text-white">
            {currentProject.category}
          </span>
        </div>

        <h1 className="text-6xl md:text-[8rem] font-bold tracking-tighter mb-12 leading-none project-anim-item text-black">
          ...
          <div className="md:col-span-8">
            ...
            <div className="mt-12 flex gap-4">
              <a
                ...
                className="bg-mind-blue text-white px-8 py-3 rounded-full font-bold text-sm hover:scale-105 transition-transform inline-block"
              >
                Visit Website
              </a>
            </div>
